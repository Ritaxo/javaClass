...
public class Databasebirthandname extends JFrame{
	...
	private List <BirthInfo> chronSortList;
	
	private List <BirthInfo> alphaSortList;
	...
	public Databasebirthandname() {
		...
		myCP.add(displaySP); 
		alphaSortList = new List <BirthInfo> ();
		chronSortList = new List <BirthInfo> (BirthInfo.DATE_COMPARATOR);
		setVisible(true);
...
//		String firstName = firstTF.getText();
	...
	/**
	 * This method makes the all the buttons invisible except the 
	...
	public class addBHandler implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			...
			if(errorMsg.equals("")) {
				...
				if(chronSortList.add(toAdd) && alphaSortList.add(toAdd)) {
	...
	public class searchBHandler implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			...
			if(errorMsg.equals("")) {
				...
				if(chronSortList.search(findME) != null && alphaSortList.search(findME) != null) {
 ...
 */
	public class chronBHandler implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			chronSortList.Sort();
			displayTA.append(chronSortList.toString() + "\n List sorted chronologically");
		} 
	}
	...
	public class alphaBHandler implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			alphaSortList.Sort();
			displayTA.append(alphaSortList.toString()+" \n List sorted alphabetically");
		} 
	}

	/**
	 * This method cancels a delete request.
	 */
	public class cancelBHandler implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			...
			dayCB.setSelectedIndex(0);
			yearTF.setText("");	
			displayTA.append(Found + "'s deletion has been canceled. \n");	
		} 
	}
	...
	public class confirmBHandler implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			if (alphaSortList.delete(Found) && chronSortList.delete(Found)) {
				displayTA.append(Found + " has been deleted.\n");	
			}else {
				displayTA.append(Found + " could not deleted.\n");	
			}
		} 
	}//confirmBHandler
	...
	public class deleteBHandler implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			...
			if(errorMsg.equals("")) {
				BirthInfo findME = new BirthInfo (firstName, middleName, lastName);
				Found = chronSortList.search(findME);
				if(Found != null) {
