...
/**
 * Three of the  application's buttons will each increase by 20 one color component
 * (red or green or blue) of the background color of the content pane 
 * until the maximum is reached for that component. A reset button resets the 
 * background color of the content pane to black.
...
public class AddColor extends JFrame {
	...
	public AddColor () {
		...
		redB = makeButton(30,75,120,50, "Increase Red",Color.RED, (ActionEvent e) -> handleOneColor(Color.RED));
		greenB = makeButton(180,75,120,50, "Increase Green",Color.GREEN, (ActionEvent e) -> handleOneColor(Color.GREEN));
		blueB = makeButton(330,75,120,50, "Increase Blue",Color.BLUE, (ActionEvent e) -> handleOneColor(Color.BLUE));
